...
function AddKnowledgeBaseForm() {
  ...
  const getDescriptionPlaceholder = () => {
    ...
    switch (entityType) {
      ...
      case 'darurat':
        return infoType === 'umum'
          ? "Tuliskan penjelasan lengkap basis pengetahuan / materi AI: detail fakta, sejarah, statistik, profil tokoh/Bupati, peraturan daerah, atau petunjuk wisata umum lainnya agar AI dapat memahaminya..."
          : "Tuliskan penjelasan lengkap layanan darurat: jenis layanan/bantuan, nomor telepon aktif, alamat fisik, dan prosedur saat keadaan darurat agar AI dapat memberikan info cepat...";
      default:
